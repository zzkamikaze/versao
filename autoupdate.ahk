...
if (Currversion > version) ;se a versão for mais recente que a versão atual Peça para baixar a nova versão
	{
...
Gui, Update:Add, Text, x5 y90 w125 h15, Você gostaria de atualizar?      ;Text asking if the user wants to update to the newer version
Gui, Update:Add, Button, x85 y120 w43 h23 gYes, Yes                        ;If pressed it will go to the Yes sub to download the newest version available
Gui, Update:Add, Button, x135 y120 w43 h23 gHome, No                     ;Will skip the update and go to the main functions
Gui, Update:Show, w190 h200, Update?                                     ;Update window title.
}
